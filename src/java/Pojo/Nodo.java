...
@NamedQuery(name = "nodo.findByCargo", query = "SELECT n FROM Nodo n WHERE n.cargo = :cargo"),
@NamedQuery(name = "nodo.findByIdPadre", query = "SELECT n FROM Nodo n WHERE n.idPadre = :idPadre")})
